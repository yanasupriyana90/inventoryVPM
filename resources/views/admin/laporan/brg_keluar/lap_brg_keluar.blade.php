                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                ...
                                <button class="btn btn-primary btn-rounded ml-auto" data-toggle="modal" data-target="#modalCetak">
...
<div class="modal fade" id="modalCetak" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form method="GET" target="_blank" enctype="multipart/form-data" action="/lap_brg_keluar/cetak_brg_keluar">
                @csrf
